import { GeneratorConfig } from '@src/domain.objects';
import { getAllPathsMatchingGlobs } from '@src/domain.operations/config/getConfig/getAllPathsMatchingGlobs/getAllPathsMatchingGlobs';
