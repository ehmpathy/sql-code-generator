...
import type { TypeDefinitionOfResourceFunction } from '@src/domain.objects/TypeDefinitionOfResourceFunction';
...
import { defineTypescriptTypesForTable } from '@src/domain.operations/typeDefinitionsToCode/resource/table/defineTypescriptTypesForTable';
