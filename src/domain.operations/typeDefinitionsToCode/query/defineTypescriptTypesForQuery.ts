import type { TypeDefinition } from '@src/domain.objects';
import type { TypeDefinitionOfQuery } from '@src/domain.objects/TypeDefinitionOfQuery';
import type { TypeDefinitionOfQueryInputVariable } from '@src/domain.objects/TypeDefinitionOfQueryInputVariable';
import { castQueryNameToTypescriptTypeName } from '@src/domain.operations/typeDefinitionsToCode/common/castQueryNameToTypescriptTypeName';
import { defineTypescriptTypeFromDataTypeArrayOrReference } from '@src/domain.operations/typeDefinitionsToCode/common/defineTypescriptTypeFromDataTypeArrayOrReference';
...
export const defineTypescriptTypesForQuery = ({
  ...
  const inputVariableNameToTypeDefinitionsMap =
    definition.inputVariables.reduce(
