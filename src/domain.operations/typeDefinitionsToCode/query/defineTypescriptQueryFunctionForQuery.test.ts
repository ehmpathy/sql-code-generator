...
describe('defineTypescriptQueryFunctionForQuery', () => {
  it('should define the method accurately based on name and import path', () => {
    ...
    expect(imports.queryNameAlias).toEqual('sqlQueryUpsertImageSql'); // i.e., import { query as sqlQueryUpsertImageSql } from '@src/domain.operations/typeDefinitionsToCode/rel/path/to/query';
