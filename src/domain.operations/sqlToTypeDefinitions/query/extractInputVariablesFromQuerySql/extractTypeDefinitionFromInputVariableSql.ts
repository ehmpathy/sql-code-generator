import { DataType } from '@src/domain.objects';
import { TypeDefinitionOfQueryInputVariable } from '@src/domain.objects/TypeDefinitionOfQueryInputVariable';
import { TypeDefinitionReference } from '@src/domain.objects/TypeDefinitionReference';
import { throwErrorIfTableReferencePathImpliesTable } from '@src/domain.operations/sqlToTypeDefinitions/query/common/throwErrorIfTableReferencePathImpliesTable';
