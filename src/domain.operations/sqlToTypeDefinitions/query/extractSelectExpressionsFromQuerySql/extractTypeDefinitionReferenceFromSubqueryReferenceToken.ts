import type { TypeDefinitionReference } from '@src/domain.objects';
import type { SqlSubqueryReference } from '@src/domain.objects/SqlSubqueryReference';
import { getTokenForSqlSubqueryReference } from '@src/domain.operations/sqlToTypeDefinitions/query/common/flattenSqlByReferencingAndTokenizingSubqueries/getTokenForSubqueryReference';
