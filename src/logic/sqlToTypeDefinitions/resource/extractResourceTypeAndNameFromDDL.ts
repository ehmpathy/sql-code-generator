...
const MYSQL_TYPE_NAME_CAPTURE_REGEX =
  /(?:CREATE|create)(?: OR REPLACE)?(?:\s+)(?:DEFINER=`[a-zA-Z0-9_]+`@`[a-zA-Z0-9_%]+`)?(?:\s*)(PROCEDURE|procedure|FUNCTION|function|TABLE|table|VIEW|view)(?:\s+)(?:`?)(\w+)(?:`?)(?:\s*)(?:\(|AS|as)/g; // captures type and name from create statements of resources
