...
describe('extractTypeDefinitionFromTableReference', () => {
  const examples = [
    {
      sql: 'from user',
      def: new TypeDefinitionOfQueryTableReference({ alias: 'user', tableName: 'user', functionName: null }),
    },
    {
      sql: 'FROM user u',
      def: new TypeDefinitionOfQueryTableReference({ alias: 'u', tableName: 'user', functionName: null }),
    },
    {
    ...
    },
    {
      ...
      def: new TypeDefinitionOfQueryTableReference({ alias: 'm', tableName: 'meals', functionName: null }),
    },
    {
      sql: 'left join cool_db.avatars a on a.id = user.avatar_id',
      def: new TypeDefinitionOfQueryTableReference({ alias: 'a', tableName: 'avatars', functionName: null }),
    },
    {
    ...
    },
    {
      ...
      def: new TypeDefinitionOfQueryTableReference({ alias: 'best_friend', tableName: 'user', functionName: null }),
    },
    {
      sql: 'FROM upsert_job(:name, :description, __SSQ:sub_select_query__, NOW()) as dgv',
      def: new TypeDefinitionOfQueryTableReference({ alias: 'dgv', tableName: null, functionName: 'upsert_job' }),
    },
    {
